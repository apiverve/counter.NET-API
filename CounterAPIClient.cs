...
namespace APIVerve
{
    public class CounterAPIClient
    {
        ...
        public CounterAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public CounterAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, counterQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(counterQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(counterQueryOptions options)
        {
